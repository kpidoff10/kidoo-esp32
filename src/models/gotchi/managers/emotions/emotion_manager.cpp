...
bool EmotionManager::displayCurrentFrame(const EmotionPhase& phase) {
  ...
  // Exécuter les actions de cette frame (LED, vibration, etc.). La vibration
  // est lancée dans une tâche séparée et n'est jamais interrompue au changement de frame.
